...
<template>
  <div class="wrapper">
    ...
    <div class="section-wrapper" v-if="startQuiz">
      ...
      <div class="section">
        <Section
        :question-type="analysisQuiz.questions[selectedQuestionOrder]?.section_name"
          :show-next="
            analysisQuiz.questions.length != selectedQuestionOrder + 1
          "
          :show-previous="selectedQuestionOrder != 0"
          :question="analysisQuiz.questions[selectedQuestionOrder]?.question"
          :sectionName="
            analysisQuiz.questions[selectedQuestionOrder]?.section_name
          "
          :selectedQuestionOrder="selectedQuestionOrder"
          :answers="answerObj"
          :audio_link="
            analysisQuiz.questions[selectedQuestionOrder]?.audio_link
          "
          :duration="analysisQuiz.duration"
          @next="selectedQuestionOrder++"
