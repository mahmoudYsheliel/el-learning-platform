...
<template>
    <Navbar />
    <div class="container">
        <Dialog v-model:visible="showComments" modal :header="selectLang(translationModule.showComments)" :style="{ width: '50vw' }">
            <div class="msg-wrapper">
                <div class="msg" v-for="msg in enrollmentRequests[requestOrderToShowComments].comments" :class="{
        ...
        <ChildSidebar class="sidebar" selected="requests" />
        <div class="wrapper">
            <div class="requests">
                ...
                <div class="table-container">
                    ...
                    <div class="row" v-for="(req, i) in enrollmentRequests">
                        ...
                        <span>
                            ...
                            showComments = true;
                            " style="font-size: 0.75rem" :label="selectLang(translationModule.showComments)" /></span>
                    </div>
                </div>
            </div>
        </div>
